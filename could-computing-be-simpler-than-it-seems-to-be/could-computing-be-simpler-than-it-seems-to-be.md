...
If we are going to reinvent anything, it should be programming. It would be very difficult to reinvent programming since it has been embedded in pretty much the same paradigms, pretty much since I have been in computing, that goes back to 1961. If you take Simula, first appearing in 64/65 or so ... The stuff that we have today would be not only all too familiar, except for the networking. A lot of the best of the people in the 60s would think what most people are doing today as kind of retrograde. In any case, it is extremely recognizable.

#### [My questions](slides/1.png)
 I have my own versions of
